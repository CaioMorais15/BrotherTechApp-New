      ...
      <div className='row  text-center gap-5 p-5'>
        ...
        <div className='col-12 col-md texto'>
          ...
          <div className='row text-center noticias'>
            <p>Atacante LI.FI transfere 198 ETH para novo endereço
              A postura conciliatória do Fed e as reações do mercado impactam o cenário criptográfico
              Harris ganha terreno nas probabilidades das eleições presidenciais de 2024
              Capitalistas de risco se reúnem em apoio a Kamala Harris para a presidência</p>
          </div>
        </div>
